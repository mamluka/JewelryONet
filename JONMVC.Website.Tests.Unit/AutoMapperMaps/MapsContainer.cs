    ...
    public static class MapsContainer
    {
        public static void CreateAutomapperMaps()
        {
            ...
            Mapper.CreateMap<MergeExistingCustomerAndExtendedCustomer, usr_CUSTOMERS>()
                ...
                .ForMember(dto => dto.acc_CASHFLOW, opt => opt.Ignore())
                .ForMember(dto => dto.acc_ORDERS, opt => opt.Ignore())
                .ForMember(dto => dto.active, opt => opt.MapFrom(x=> x.First.active))
                .ForMember(dto => dto.aid, opt => opt.MapFrom(x => x.First.aid))
                .ForMember(dto => dto.b_city, opt => opt.MapFrom(x => x.First.b_city))
                .ForMember(dto => dto.b_country_id, opt => opt.MapFrom(x => x.First.b_country_id))
                .ForMember(dto => dto.b_fax, opt => opt.MapFrom(x => x.First.b_fax))
                .ForMember(dto => dto.b_name, opt => opt.MapFrom(x => x.First.b_name))
                .ForMember(dto => dto.b_phone, opt => opt.MapFrom(x => x.First.b_phone))
                .ForMember(dto => dto.b_pobox, opt => opt.MapFrom(x => x.First.b_pobox))
                .ForMember(dto => dto.b_siteurl, opt => opt.MapFrom(x => x.First.b_siteurl))
                .ForMember(dto => dto.b_specialization, opt => opt.MapFrom(x => x.First.b_specialization))
                .ForMember(dto => dto.b_state_id, opt => opt.MapFrom(x => x.First.b_state_id))
                .ForMember(dto => dto.b_street, opt => opt.MapFrom(x => x.First.b_street))
                .ForMember(dto => dto.b_tradingass, opt => opt.MapFrom(x => x.First.b_tradingass))
                .ForMember(dto => dto.b_type_id, opt => opt.MapFrom(x => x.First.b_type_id))
                .ForMember(dto => dto.b_zip, opt => opt.MapFrom(x => x.First.b_zip))
                .ForMember(dto => dto.dateofbirth, opt => opt.MapFrom(x => x.First.dateofbirth))
                .ForMember(dto => dto.dealer, opt => opt.MapFrom(x => x.First.dealer))
                .ForMember(dto => dto.default_currency, opt => opt.MapFrom(x => x.First.default_currency))
                .ForMember(dto => dto.fax1, opt => opt.MapFrom(x => x.First.fax1))
                .ForMember(dto => dto.fax2, opt => opt.MapFrom(x => x.First.fax2))
                .ForMember(dto => dto.historical_user, opt => opt.MapFrom(x => x.First.historical_user))
                .ForMember(dto => dto.id, opt => opt.MapFrom(x => x.First.id))
                .ForMember(dto => dto.idex_percent, opt => opt.MapFrom(x => x.First.idex_percent))
                .ForMember(dto => dto.inv_mail, opt => opt.MapFrom(x => x.First.inv_mail))
                .ForMember(dto => dto.inv_update, opt => opt.MapFrom(x => x.First.inv_update))
                .ForMember(dto => dto.last_visit, opt => opt.MapFrom(x => x.First.last_visit))
                .ForMember(dto => dto.lastmodify_date, opt => opt.MapFrom(x => x.First.lastmodify_date))
                .ForMember(dto => dto.lastmodify_user, opt => opt.MapFrom(x => x.First.lastmodify_user))
                .ForMember(dto => dto.lastmodify_user_id, opt => opt.MapFrom(x => x.First.lastmodify_user_id))
                .ForMember(dto => dto.old_id, opt => opt.MapFrom(x => x.First.old_id))
                .ForMember(dto => dto.online_message, opt => opt.MapFrom(x => x.First.online_message))
                .ForMember(dto => dto.pobox1, opt => opt.MapFrom(x => x.First.pobox1))
                .ForMember(dto => dto.pobox2, opt => opt.MapFrom(x => x.First.pobox2))
                .ForMember(dto => dto.prf_language_id, opt => opt.Ignore())
                .ForMember(dto => dto.prf_list_amount, opt => opt.Ignore())
                .ForMember(dto => dto.prf_srtkey_diamonds, opt => opt.Ignore())
                .ForMember(dto => dto.prf_srtkey_gemstones, opt => opt.Ignore())
                ...
                .ForMember(dto => dto.prf_srtkey_specials, opt => opt.Ignore())
                .ForMember(dto => dto.prf_timesvisited, opt => opt.Ignore())
                .ForMember(dto => dto.registration_ip, opt => opt.MapFrom(x => x.First.registration_ip))
                .ForMember(dto => dto.sys_COUNTRY, opt => opt.Ignore())
                .ForMember(dto => dto.sys_COUNTRYReference, opt => opt.Ignore())
                .ForMember(dto => dto.sys_STATE, opt => opt.Ignore())
                .ForMember(dto => dto.sys_STATEReference, opt => opt.Ignore())
                ...
                .ForMember(dto => dto.sys_STATE1, opt => opt.Ignore())
                .ForMember(dto => dto.sys_STATE1Reference, opt => opt.Ignore())
                .ForMember(dto => dto.userdeleted, opt => opt.MapFrom(x => x.First.userdeleted))
